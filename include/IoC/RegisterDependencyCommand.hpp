...
namespace ioc {
  ...
  public:
    RegisterDependency(std::string dependency, IocFunctor dependency_resolver_strategy)
      : dependency_ { dependency }, dependency_resolver_strategy_ { dependency_resolver_strategy } {}
